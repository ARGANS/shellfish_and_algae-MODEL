...
```{r parsubs, echo=FALSE, fig.cap='Bantry Bay par data (red points) with substituted data highlighed (black circles). Modelled clear-sky par shown as solid line'}
source('bantry_run.R')
