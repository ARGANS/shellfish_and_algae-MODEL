...
DATA_DIR='/cygdrive/c/Users/User/Documents/argans/CINEA/data'
MAPS_DIR='/cygdrive/c/Users/User/Documents/argans/CINEA/data/Maps'
OUT_DIR='./out'
TMP_DIR='./tmp'
...
scenario='B' # 'A'
if scenario == 'A':
    zones=['BAL','BKS','NWS','IBI','MED','ARC'] # zones à traite
elif scenario == 'B':
...
for espece in especes:
    for param in params:
        for zone in zones:
            if scenario == 'A':
                ficin=DATA_DIR + f'/Scenario{scenario}/{espece}/{zone}/posttreatment/{param}.tif'
            elif scenario == 'B':
                ficin=DATA_DIR + f'/Scenario{scenario}/{espece}/{espece}{zone}/{param}.tif'
